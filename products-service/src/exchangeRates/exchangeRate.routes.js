...
/**
 * @swagger
 * /BancoLa33/v1/exchangeRates/convert:
 *   get:
 *     summary: Convertir monto entre monedas
 *     description: Usa API externa (Frankfurter) con respaldo en tasas locales de la BD
 *     tags: [Exchange Rates]
 *     parameters:
 *       - in: query
 *         name: fromCurrency
 ...
 *         schema:
 *           type: string
 *         description: Código ISO origen (ej. USD)
 *       - in: query
 *         name: toCurrency
 *         required: true
 *         schema:
 *           type: string
 *         description: Código ISO destino (ej. GTQ)
 *       - in: query
 *         name: amount
 *         required: true
 *         schema:
 ...
 *         schema:
 *           type: boolean
 *         description: Si true, solo usa tasas de la BD
 *     responses:
 *       200:
 ...
 *       503:
 *         description: Sin tasa disponible
 */
