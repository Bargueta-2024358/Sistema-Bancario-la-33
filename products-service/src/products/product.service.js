...
export const fetchProductById = async (id) => {
  return Product.findById(id).populate('currency', 'code name symbol');
};

export const populateProductCurrency = (id) =>
  Product.findById(id).populate('currency', 'code name symbol');
...
export const createProductRecord = async ({ productData }) => {
  ...
  return populateProductCurrency(product._id);
};
...
export const updateProductRecord = async ({ id, updateData }) => {
  ...
  return product ? populateProductCurrency(product._id) : null;
};
